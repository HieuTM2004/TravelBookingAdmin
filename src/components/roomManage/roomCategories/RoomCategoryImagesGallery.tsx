...
import { removeImageFromRoomCategory } from "../../../api/roomcategoryAPI";
import type { Image } from "../../../types/accommodation.types";
import AddImageToRoomCategoryModal from "./AddImageToRoomCategoryModal";
...
const RoomCategoryImagesGallery: React.FC<Props> = ({
  images,
  onAdd,
  categoryId,
  onRefresh,
  ...
  const handleRemove = async (imageId: string) => {
    if (window.confirm("Are you sure you want to remove this image?")) {
      try {
        await removeImageFromRoomCategory(categoryId, imageId); // RoomCategory API
        onRefresh();
      } catch (error) {
...
export default RoomCategoryImagesGallery;
